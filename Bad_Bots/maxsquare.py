        ...
        for x in range(8):
            ...
            if p == 1 or p == 7:
                ...
                for i in range(8):
                    ...
                    if 0 <= yk <= 7 and 0 <= xk <= 7 and ((turn and not (1 <= board[yk][xk] <= 6)) or (not turn and not (7 <= board[yk][xk] <= 12))):
                        ...
                        kings[1 - turn] = [yk, xk]
                        if not check(turn):
                            soop.append([(y, x), (yk, xk)])
                            cnt += 1
                        board[yk][xk] = kill
                        board[y][x] = p
                        kings[1 - turn] = [y, x]
            while len(soop) > 2:
                del soop[randint(0, len(soop) - 1)]
            # DIAGONALS
            ...
            if p == 6:
                ...
                if 0 <= yk <= 7 and 0 <= xk <= 7 and board[yk][xk] == 0:
                    ...
                    if not check(turn):
                        if yk == 0:
                            poss.append([(y, x), (yk, xk), 2])
                            poss.append([(y, x), (yk, xk), 3])
                            poss.append([(y, x), (yk, xk), 4])
                            poss.append([(y, x), (yk, xk), 5])
                        else:
                            poss.append([(y, x), (yk, xk)])
                        cnt += 1
                    board[yk][xk] = 0
                    board[y][x] = p
                if y == 6:
            ...
            if p == 12:
                ...
                if 0 <= yk <= 7 and 0 <= xk <= 7 and board[yk][xk] == 0:
                    ...
                    if not check(turn):
                        if yk == 7:
                            poss.append([(y, x), (yk, xk), 8])
                            poss.append([(y, x), (yk, xk), 9])
                            poss.append([(y, x), (yk, xk), 10])
                            poss.append([(y, x), (yk, xk), 11])
                        else:
                            poss.append([(y, x), (yk, xk)])
                        cnt += 1
                    board[yk][xk] = 0
