...
def main(board1, last_first_move1, castle1, kings1, turn1):
    global board, last_first_move, castle, kings, event, fifty, allp, first
    if first:
        qwerty[1] = randint(0, 2147483647)
        qwerty[2] = randint(0, 2147483647)
        qwerty[3] = randint(0, 2147483647)
        qwerty[4] = randint(0, 2147483647)
        qwerty[5] = randint(0, 2147483647)
        qwerty[6] = randint(0, 2147483647)
        qwerty[7] = randint(0, 2147483647)
        qwerty[8] = randint(0, 2147483647)
        qwerty[9] = randint(0, 2147483647)
        qwerty[10] = randint(0, 2147483647)
        qwerty[11] = randint(0, 2147483647)
        qwerty[12] = randint(0, 2147483647)
        first = False
    board = board1
