...
def ev():
    moveswhite = moves(1)
    movesblack = moves(0)
    if len(moveswhite) == 0 and check(1):
        return -600
    elif len(movesblack) == 0 and check(0):
        return 600
    elif len(moveswhite) == 0:
        return 0
...
def go(n, t):
    global board, last_first_move, castle, kings, event, fifty, allp, turny
    if n == 0:
        return ev()
